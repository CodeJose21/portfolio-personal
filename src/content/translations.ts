...
const es = {
  ...
  skillTools: [['Python', 'Java', 'C', 'Haskell', 'SQL', 'R'], ['YOLO', 'Análisis de datos'], ['IA como herramienta de trabajo', 'Github Actions', 'Office 365', 'Google Workspace']],
...
const en: Translation = {
  ...
  skillTools: [['Python', 'Java', 'C', 'Haskell', 'SQL', 'R'], ['YOLO', 'Data analysis'], ['AI as a work tool', 'Github Actions', 'Office 365', 'Google Workspace']],
...
const de: Translation = {
  ...
  skillTools: [['Python', 'Java', 'C', 'Haskell', 'SQL', 'R'], ['YOLO', 'Datenanalyse'], ['KI als Arbeitswerkzeug', 'Github Actions', 'Office 365', 'Google Workspace']],
